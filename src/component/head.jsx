...
export default function Head({ autoView, setView }) {
  ...
  return(
    <div className='w-screen h-[10vh] flex flex-col bg-blue-500 relative'>
      ...
      <div className='flex flex-row w-[100%] h-[30px] absolute bottom-0 text-center'>
        <div 
          className='w-[50%] h-inherit bg-blue-400 border-r' 
          onClick={click}
        >
          Load Quiz
        </div>
        <div className='w-[50%] h-inherit bg-blue-400 border-1'>Responden</div>
      </div>
    </div>
  );
};
